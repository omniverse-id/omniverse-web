...
export const Footer: React.FC<FooterProps> = ({ language }) => {
  ...
  return (
    <footer className="bg-zinc-50 border-t border-zinc-150 py-16 scroll-mt-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 pt-8 border-t border-zinc-150 flex flex-col sm:flex-row items-center justify-between gap-4 text-2xs font-mono text-zinc-450 font-bold">
